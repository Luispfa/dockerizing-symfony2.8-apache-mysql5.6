...
class HeaderWeekly extends PageContainer implements Page{
    var $servicio;
    ...
    function getBody($pdf) {
        ...
        $pdf->Image("web/images/logo.jpg", 1, 0.5, null, null, "JPG", null, "http://www.header.net");
        
        //Tabla de cabecera
        $A = "Informe semanal de ". $this->servicio;
        $AB= $client;
        $B = "Fecha: ";
