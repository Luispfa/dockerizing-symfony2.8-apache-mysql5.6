...
class UsoPageWeekly2 extends PageContainer implements Page{
    var $site;
    ...
    public function getBody($pdf){
        ...
        $pdf->setY($y+=.3);
        $pdf->titulo2F();
        $pdf->write(.3,utf8_decode("Estadísticas web de todo el periodo"));
        ...
        $statement = 
                "A continuación se presentan los datos relevantes de navegación desde el día de su apertura hasta el momento:\n\n"
