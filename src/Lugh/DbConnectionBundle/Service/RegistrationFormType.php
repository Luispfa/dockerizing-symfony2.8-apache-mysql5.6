...
class RegistrationFormType extends BaseRegistrationType
{
    /**
     * @param string $class The User class name
     * @param string $customClass The User Custom class name
     */
    public function __construct($class, $custom_class)
    {
        global $kernel;
