 ...
 * @author a.navarro
 */
class FinalizadoStateClass extends JuntaStateClass {
    
    public function asistencia($junta) {
        $junta->setState(StateClass::stateAsistencia);
        if ($this->setStatesDefault($junta, StateClass::stateFinalizado, StateClass::stateAsistencia) == null) {
    ...
    public function configuracion($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateFinalizado, StateClass::stateConfiguracion) == null) {
    ...
    public function convocatoria($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateFinalizado, StateClass::stateConvocatoria) == null) {
    ...
    public function finalizado($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateFinalizado, StateClass::stateFinalizado) == null) {
    ...
    public function prejunta($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateFinalizado, StateClass::statePrejunta) == null) {
    ...
    public function quorumcerrado($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateFinalizado, StateClass::stateQuorumCerrado) == null) {
    ...
    public function votacion($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateFinalizado, StateClass::stateVotacion) == null) {
