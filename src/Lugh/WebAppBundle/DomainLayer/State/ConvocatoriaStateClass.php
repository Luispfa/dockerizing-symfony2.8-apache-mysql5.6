 ...
 * @author a.navarro
 */
class ConvocatoriaStateClass extends JuntaStateClass {
    
    public function asistencia($junta) {
        $junta->setState(StateClass::stateAsistencia);
        if ($this->setStatesDefault($junta, StateClass::stateConvocatoria, StateClass::stateAsistencia) == null) {
    ...
    public function configuracion($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateConvocatoria, StateClass::stateConfiguracion) == null) {
    ...
    public function convocatoria($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateConvocatoria, StateClass::stateConvocatoria) == null) {
    ...
    public function finalizado($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateConvocatoria, StateClass::stateFinalizado) == null) {
    ...
    public function prejunta($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateConvocatoria, StateClass::statePrejunta) == null) {
    ...
    public function quorumcerrado($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateConvocatoria, StateClass::stateQuorumCerrado) == null) {
    ...
    public function votacion($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateConvocatoria, StateClass::stateVotacion) == null) {
