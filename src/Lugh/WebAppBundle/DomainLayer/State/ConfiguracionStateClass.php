 ...
 * @author a.navarro
 */
class ConfiguracionStateClass extends JuntaStateClass {
    
    public function asistencia($junta) {
        $junta->setState(StateClass::stateAsistencia);
        if ($this->setStatesDefault($junta, StateClass::stateConfiguracion, StateClass::stateAsistencia) == null) {
    ...
    public function configuracion($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateConfiguracion, StateClass::stateConfiguracion) == null) {
    ...
    public function convocatoria($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateConfiguracion, StateClass::stateConvocatoria) == null) {
    ...
    public function finalizado($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateConfiguracion, StateClass::stateFinalizado) == null) {
    ...
    public function prejunta($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateConfiguracion, StateClass::statePrejunta) == null) {
    ...
    public function quorumcerrado($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateConfiguracion, StateClass::stateQuorumCerrado) == null) {
    ...
    public function votacion($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateConfiguracion, StateClass::stateVotacion) == null) {
