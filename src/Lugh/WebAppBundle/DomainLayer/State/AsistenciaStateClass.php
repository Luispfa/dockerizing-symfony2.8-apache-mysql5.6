 ...
 * @author a.navarro
 */
class AsistenciaStateClass extends JuntaStateClass {
    
    public function asistencia($junta) {
        $junta->setState(StateClass::stateAsistencia);
        if ($this->setStatesDefault($junta, StateClass::stateAsistencia, StateClass::stateAsistencia) == null) {
    ...
    public function configuracion($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateAsistencia, StateClass::stateConfiguracion) == null) {
    ...
    public function convocatoria($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateAsistencia, StateClass::stateConvocatoria) == null) {
    ...
    public function finalizado($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateAsistencia, StateClass::stateFinalizado) == null) {
    ...
    public function prejunta($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateAsistencia, StateClass::statePrejunta) == null) {
    ...
    public function quorumcerrado($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateAsistencia, StateClass::stateQuorumCerrado) == null) {
    ...
    public function votacion($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateAsistencia, StateClass::stateVotacion) == null) {
