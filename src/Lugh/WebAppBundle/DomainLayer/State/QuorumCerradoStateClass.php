 ...
 * @author a.navarro
 */
class QuorumCerradoStateClass extends JuntaStateClass {
    
    public function asistencia($junta) {
        $junta->setState(StateClass::stateAsistencia);
        if ($this->setStatesDefault($junta, StateClass::stateQuorumCerrado, StateClass::stateAsistencia) == null) {
    ...
    public function configuracion($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateQuorumCerrado, StateClass::stateConfiguracion) == null) {
    ...
    public function convocatoria($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateQuorumCerrado, StateClass::stateConvocatoria) == null) {
    ...
    public function finalizado($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateQuorumCerrado, StateClass::stateFinalizado) == null) {
    ...
    public function prejunta($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateQuorumCerrado, StateClass::statePrejunta) == null) {
    ...
    public function quorumcerrado($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateQuorumCerrado, StateClass::stateQuorumCerrado) == null) {
    ...
    public function votacion($junta) {
        ...
        if ($this->setStatesDefault($junta, StateClass::stateQuorumCerrado, StateClass::stateVotacion) == null) {
