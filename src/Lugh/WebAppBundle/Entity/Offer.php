...
class Offer extends Item
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="AdhesionOffer", mappedBy="offer", cascade={"persist", "remove"})
     * @Expose
     * @Groups({"adhesions"}) 
     */
    private $adhesions;
    ...
    /**
     * @ORM\OneToMany(targetEntity="Message", mappedBy="offer", cascade={"persist", "remove"})
     * @Expose
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Accionista", inversedBy="offers", cascade={"persist"})
     ...
     * Add adhesions
     *
     * @param \Lugh\WebAppBundle\Entity\AdhesionOffer $adhesions
     * @return Offer
     */
    public function addAdhesion(\Lugh\WebAppBundle\Entity\AdhesionOffer $adhesions)
    {
        $adhesions->setOffer($this);
     ...
     * @param \Lugh\WebAppBundle\Entity\AdhesionOffer $adhesions
     */
    public function removeAdhesion(\Lugh\WebAppBundle\Entity\AdhesionOffer $adhesions)
    {
