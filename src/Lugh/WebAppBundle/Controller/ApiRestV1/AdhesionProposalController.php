...
use Lugh\WebAppBundle\DomainLayer\State\StateClass;
 ...
 /**
 * @RouteResource("AdhesionProposal")
 */
class AdhesionProposalController extends Controller {
    ...
    }// "get_resources"     [GET] /adhesionproposals
    ...
    public function getAction($id) // GET Resource
    {
        ...
        $serializer = $this->container->get('jms_serializer');
        try {
            $adhesionProposal = $storage->getAdhesionProposal($id);
            $items = array
                    ( 
                        'adhesionProposals'     =>  $adhesionProposal
                    );
        } catch (Exception $exc) {
    ...
    }// "get_resource"      [GET] /adhesionproposals/{id}
    ...
    public function putTestAction($id, $state)
    {
        ...
        try {
            $item = $storage->getAdhesionProposal($id);
    ...
    } // "put_resource"     [PUT] /adhesionoffers/{id}/tests/{state}
    ...
    }// "put_resource"      [PUT] /adhesionproposals/{id}/pending
    ...
    }// "put_resource"      [PUT] /adhesionproposals/{id}/public
    ...
    }// "put_resource"      [PUT] /adhesionproposals/{id}/retornate
    ...
    }// "put_resource"      [PUT] /adhesionproposals/{id}/reject
