...
use Lugh\WebAppBundle\DomainLayer\State\StateClass;
 ...
 /**
 * @RouteResource("AdhesionOffer")
 */
class AdhesionOfferController extends Controller {
    ...
    }// "get_resources"     [GET] /adhesionOffers
    ...
    public function getAction($id) // GET Resource
    {
        ...
        $serializer = $this->container->get('jms_serializer');
        try {
            $adhesionOffer = $storage->getAdhesionOffer($id);
            $items = array
                    (
                        'adhesionOffers'        =>  $adhesionOffer
                    );
        } catch (Exception $exc) {
    ...
    }// "get_resource"      [GET] /adhesionOffers/{id}
    ...
    public function putTestAction($id, $state)
    {
        ...
        try {
            $item = $storage->getAdhesionOffer($id);
    ...
    }// "put_resource"      [PUT] /adhesionoffers/{id}/pending
    ...
    }// "put_resource"      [PUT] /adhesionoffers/{id}/public
    ...
    }// "put_resource"      [PUT] /adhesionoffers/{id}/retornate
    ...
    }// "put_resource"      [PUT] /adhesionoffers/{id}/reject
