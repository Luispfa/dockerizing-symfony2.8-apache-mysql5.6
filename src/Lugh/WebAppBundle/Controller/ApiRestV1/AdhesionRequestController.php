...
use Lugh\WebAppBundle\DomainLayer\State\StateClass;
 ...
 /**
 * @RouteResource("AdhesionRequest")
 */
class AdhesionRequestController extends Controller {
    ...
    }// "get_resources"     [GET] /adhesionrequests
    ...
    public function getAction($id) // GET Resource
    {
        ...
        $serializer = $this->container->get('jms_serializer');
        try {
            $adhesionRequest = $storage->getAdhesionRequest($id);
            $items = array
                    (  
                        'adhesionRequests'      =>  $adhesionRequest
                    );
        } catch (Exception $exc) {
    ...
    }// "get_resource"      [GET] /adhesionrequests/{id}
    ...
    public function putTestAction($id, $state)
    {
        ...
        try {
            $item = $storage->getAdhesionRequest($id);
    ...
    } // "put_resource"     [PUT] /adhesionrequests/{id}/tests/{state}
    ...
    }// "put_resource"      [PUT] /adhesionrequests/{id}/pending
    ...
    }// "put_resource"      [PUT] /adhesionrequests/{id}/public
    ...
    }// "put_resource"      [PUT] /adhesionrequests/{id}/retornate
    ...
    }// "put_resource"      [PUT] /adhesionrequests/{id}/reject
