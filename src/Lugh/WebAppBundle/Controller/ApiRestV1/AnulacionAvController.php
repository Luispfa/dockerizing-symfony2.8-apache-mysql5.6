...
use JMS\Serializer\SerializationContext;
 ...
 /**
 * @RouteResource("AnulacionAv")
 */
class AnulacionAvController extends Controller {
    ...
    { 
        ...
        try {
            $anulaciones = $storage->getAnulacionesAv();
            $items = array('anulaciones' => $anulaciones);
        } catch (Exception $exc) {
    ...
    public function postAction() // Create Resource
    {
        ...
        try {       
           ...
           $anulacion = $builder->buildAnulacionAv();
    ...
    }// "new_opcionesvotos"     [POST] /anulacionavs
